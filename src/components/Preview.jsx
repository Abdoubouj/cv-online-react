            ...
            <div className="skills px-3 mt-10 text-slate-50">
                ...
                {skills && skills.map((skill)=>(
                   <li key={skill?.id} className='list-disc ms-5 capitalize text-[14px] font-[300]'>
                    <span className='inline-block w-[110px]'>{skill?.skillName}</span>
                    <span className='progress inline-block rounded-md w-[70px] h-[8px] border-[1px] border-slate-100'>
                        <div className="bar h-full bg-slate-50" style={{width:`${skill.skillLevel}%`}}></div>
                    </span>
                   </li>
                  ))}
                  </ul>
            ...
            <div className="languages px-3 mt-10 text-slate-50">
                ...
                {languages.map((lang)=>(
                   <li key={lang?.id} className='list-disc ms-5 capitalize text-[14px] font-[300]'>
                    ...
                    <span className='progress inline-block rounded-md w-[70px] h-[8px] border-[1px] border-slate-100'>
                        <div className="bar h-full bg-slate-50" style={{width:`${lang.languageLevel}%`}}></div>
                    </span>
                   </li>
                  ))}
                  </ul>
