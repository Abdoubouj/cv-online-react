    ...
    <header className='h-[90px]'>
       <div className="header dark:bg-slate-800 px-10 h-full border-b-2 border-slate-200 dark:border-slate-700 flex items-center justify-between">
        ...
        <nav className='flex items-center justify-center gap-5'>
          ...
          <NavLink className="py-2 px-5 transition duration-300 ease-linear text-mainColor dark:bg-slate-700 bg-slate-50 border-[1px] border-mainColor rounded-2xl" to="/educations">Educations</NavLink>
